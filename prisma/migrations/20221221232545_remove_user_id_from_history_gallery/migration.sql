/*
  ...
  - You are about to drop the column `user_id` on the `history_gallery` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX `history_gallery_user_id_idx` ON `history_gallery`;
...
-- AlterTable
ALTER TABLE `history_gallery` DROP COLUMN `user_id`;
